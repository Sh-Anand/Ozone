...
#define THREAD_MUTEX_ENTER_NESTED(mutex) thread_mutex_lock_nested(mutex); do
...
#define THREAD_MUTEX_ENTER_NESTED_IF(mutex, b) if (b) { thread_mutex_lock_nested(mutex); } do
